...
public class WorkController {
    ...
    public ResponseEntity<ResponseDto<?>> getAllByMilestone(
        ...
        return new ResponseEntity<>(ResponseDto.success("success", workFacade.getAllByMilestone(projectId, milestoneId, pageIndex.orElse(0), itemCount.orElse(5))), HttpStatus.OK);
    }

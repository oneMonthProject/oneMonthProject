...
public class WorkService {
    ...
    /**
     * 프로젝트 내 업무 생성 TODO : 유저 jwt token으로 받아와서 넣어주기
     *
     * @param projectId
     * @param milestoneId
     */
    public void create(
        ...
        User user =
                userRepository
                        .findById(workCreateRequestDto.getAssignedUserId())
    ...
    public void update(Long workId, WorkUpdateRequestDto workUpdateRequestDto) {
        ...
        ProjectMember projectMember =
                projectMemberRepository
                        .findProjectMemberByProjectAndUser(work.getProject(), user)
                        .orElseThrow(() -> ProjectMemberCustomException.NOT_FOUND_PROJECT_MEMBER);
    ...
    public void updateAssignUser(
        ...
        User user =
                userRepository
                        .findById(workUpdateAssignUserRequestDto.getAssignedUserId())
                        .orElseThrow(() -> UserCustomException.NOT_FOUND_USER);
        ProjectMember projectMember =
                projectMemberRepository
                        .findProjectMemberByProjectAndUser(work.getProject(), user)
